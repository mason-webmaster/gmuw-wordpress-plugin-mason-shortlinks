...
function gmuw_sl_custom_dashboard_meta_box_general() {
	...
	<p>If you need a shortlink for a domain that isn't pre-approved for self‑service creation, you can <a href="<?php echo esc_url(get_option('gmuw_sl_options')['gmuw_sl_ticket_url']); ?>" target="_blank">submit a request ticket for review</a>.</p>
